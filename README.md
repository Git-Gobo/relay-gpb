...
frequency is the board's own heartbeat: **44.896 kHz — one kilohertz per logged message**
(live counter 44,896), and every released dispatch gets its own frequency (No. 24 → 44.919 kHz).
