...
frequency is the board's own heartbeat: **45.062 kHz — one kilohertz per logged message**
(live counter 45,062), and every released dispatch gets its own frequency (No. 21 → 45.082 kHz).
