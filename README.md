...
frequency is the board's own heartbeat: **40.655 kHz — one kilohertz per logged message**
(live counter 40,655), and every released dispatch gets its own frequency (No. 24 → 40.678 kHz).
